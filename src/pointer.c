...
int main(void) {
    ...
    // int 민수 = 3;
    //
    // printf("철수의 주소는 %d, 암호 %d\n", &철수, 철수);
    // printf("영희의 주소는 %d, 암호 %d\n", &영희, 영희);
    // printf("민수의 주소는 %d, 암호 %d\n", &민수, 민수);
    //
    // // 미션맨
    //
    // // 첫 번째 민션 : 아파트의 각 집에 방문하여 문에 적힌 암호 확인
    // int * 미션맨; // 포인터 변수
    // 미션맨 = &철수;
    ...
    // 주소값을 넘기면? 메모리 공간에 있는 주소값 자제를 넘기면... 철수네 처럼
